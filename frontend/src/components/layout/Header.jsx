    ...
    <header className="sticky top-0 z-30 glass-card border-b border-white/20 dark:border-gray-800/50 rounded-none shadow-lg backdrop-blur-xl">
      <div className="px-4 sm:px-6 h-16 flex items-center justify-between">
        ...
        <div className="flex items-center gap-3">
          {/* Botón sidebar - mejorado: redondo, con fondo sutil y sin elementos encima */}
          <button
            onClick={onMenuClick}
            className="p-2 rounded-full bg-gray-100/80 dark:bg-gray-800/80 hover:bg-gray-200 dark:hover:bg-gray-700 transition-all duration-200 shadow-sm hover:shadow-md focus:outline-none flex items-center justify-center"
          ...
          {/* Separador vertical opcional (mejora visual) */}
          <div className="w-px h-6 bg-gray-300 dark:bg-gray-700 hidden sm:block"></div>

          {/* Logo institucional */}
          <div className="flex items-center">
            <div className="h-59 w-14 ">
              <img
                src="../../../src/assets/favicon_uno.png"
                alt="GobIA Auditor"
        ...
        {/* Sección derecha: notificaciones, tema, usuario, salir */}
        <div className="flex items-center gap-2 sm:gap-4">
          ...
          <button 
            ...
            className="p-2 rounded-full hover:bg-gray-200/50 dark:hover:bg-gray-800/50 transition"
          ...
          <div className="flex items-center gap-2 sm:gap-3 pl-2 border-l border-gray-200 dark:border-gray-700">
            <div className="h-8 w-8 rounded-full bg-gradient-to-br from-purple-500 to-indigo-600 flex items-center justify-center text-white text-sm font-bold shadow-sm">
