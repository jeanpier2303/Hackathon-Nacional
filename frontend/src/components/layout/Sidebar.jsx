...
const Sidebar = ({ collapsed = false }) => {
  ...
  return (
    <motion.aside
      ...
      className="bg-white/80 dark:bg-gray-900/80 backdrop-blur-md border-r border-gray-200 dark:border-gray-800 h-[calc(100vh-4rem)] sticky top-16 overflow-y-auto relative shadow-sm"
    >
