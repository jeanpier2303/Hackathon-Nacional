  ...
  return (
    <Card className="p-5 h-full">
      ...
      <div className="flex flex-col items-center">
        ...
        <div className="mt-4 w-full grid grid-cols-3 text-center text-xs text-gray-500">
          <span>Bajo (0-39%)</span>
        ...
        <p className="mt-4 text-sm text-gray-500 dark:text-gray-400 bg-gray-50 dark:bg-gray-800 p-3 rounded-lg text-center">
          Nivel de opacidad estimado en los procesos auditados.<br />
          <span className="text-xs">Basado en IA predictiva</span>
        </p>
      </div>
    </Card>
  );
